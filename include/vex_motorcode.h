...
#ifndef   VCS_MOTOR_GROUP_CLASS_H
#define   VCS_MOTOR_GROUP_CLASS_H
  ...
  class motor_group  {
    private:
      ...
      class  motor_group_motors {
        ...
        private:
          ...
          uint32_t  _memory[STATIC_MEMORY];
    ...
    public:      
      ...
      */
      ...
      /** 
       * @brief Starts spinning the motors to an absolute target rotation but does not wait for the motors to reach that target.
       * @param rotation Sets the amount of rotation.
       * @param units The measurement unit for the rotation value.
       * @param velocity Sets the amount of velocity.
       * @param units_v The measurement unit for the velocity value.
      ...
      /** 
       * @brief Starts spinning the motors to a relative target rotation but does not wait for the motors to reach that target.
       * @param rotation Sets the amount of rotation.
       * @param units The measurement unit for the rotation value. 
       * @param velocity Sets the amount of velocity.
       * @param units_v The measurement unit for the velocity value.
      ...
      /** 
       * @brief Starts spinning the motors to a relative target but does not wait for the motors to reach that target.
       * @param rotation Sets the amount of rotation.
       * @param units The measurement unit for the rotation value.        
       */
      ...
      /** 
       * @brief Gets the electrical current of the first motor in the group.
